...
const Header = ({ data }) => {
    ...
    return data && (
        <div
            style={{ background: `linear-gradient(rgba(0,0,0,.4),rgba(0,0,0,.7),rgba(0,0,0,.9)), url(https://image.tmdb.org/t/p/original/${data.backdrop_path || data.profile_path})`,
             backgroundPosition: "top-10", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}
